        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Focusing on backend development, designing scalable REST APIs, managing relational and non-relational databases, and engineering robust backend services.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Creating responsive e-commerce platforms, replicating layout architectures, and engineering multitasking desktop OS window management systems with smooth animations.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
